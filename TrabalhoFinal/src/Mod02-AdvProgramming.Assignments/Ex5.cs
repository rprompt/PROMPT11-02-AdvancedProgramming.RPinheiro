...
namespace Mod02_AdvProgramming.Assignments
{
    ...
    public class Ex5
    {
        ...
        //}
            ...
            //return cust
            //    .GroupBy(c => c.Country)
            //    .Select(cs => new TotalsByCountry()
            //                      {
            //                          Country = cs.Key,
            //                          NumCustomers = cs.Count(),
            //                          TotalSales =
            //                              (cs.Select(
            //                                         ts => ts.Orders
            //                                             .Select(o => o.Total)
                            ...
                            return cust
                                ...
                                .Select(cs => new TotalsByCountry()
                                {
                                    ...
                                    TotalSales =
                                        ...
                                        //dado uma sequência de Customers cs, produzir uma sequencia de orders c
                                        (cs.SelectMany(c => c.Orders)
                                    
                                        // transforma uma sequencia de orders numa sequencia de totals
                                        .Select(o => o.Total)
