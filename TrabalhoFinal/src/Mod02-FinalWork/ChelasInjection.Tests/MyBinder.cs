...
namespace ChelasInjection.Tests 
{
    ...
    public class MyBinder : Binder 
    {
        ...
        protected override void InternalConfigure() {
            ...
            //    //WithConstructor(typeof(int), typeof(ISomeInt erface2), typeof(ISomeInterface1), typeof(string)).
            ...
            //   //Bind<ISomeInterface5, SomeInterface5Impl>().WithConstructor(typeof(ISomeInterface1));

            //    Bind<ISomeInterface5, SomeInterface5Impl>().
            //        WithConstructor(typeof(int), typeof(string), typeof(float), typeof(ISomeInterface1)).
            //        WithValues(() => new {i = 5, str = "SLB", f = 0.005F}) ;
